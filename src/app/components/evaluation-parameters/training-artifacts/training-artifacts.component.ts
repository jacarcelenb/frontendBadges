...
@Component({
  selector: 'app-training-artifacts',
  templateUrl: './training-artifacts.component.html',
  styleUrls: ['./training-artifacts.component.scss']
})
export class TrainingArtifactsComponent implements OnInit {

  standard_name = "training_artifacts";
  ...
  getUploadedArtifacts() {
    this.artifactService.get({ training_artifacts: true, is_acm: true, experiment: this.id_experiment }).subscribe((data: any) => {
  ...
  save(file_url, file_content, artifact_name) {
    ...
    const artifact = {
      name: artifact_name,
      file_content: 'Training artifacts',
