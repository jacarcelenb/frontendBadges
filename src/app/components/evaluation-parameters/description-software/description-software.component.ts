...
@Component({
  selector: 'app-description-software',
  templateUrl: './description-software.component.html',
  styleUrls: ['./description-software.component.scss']
})
export class DescriptionSoftwareComponent implements OnInit {
