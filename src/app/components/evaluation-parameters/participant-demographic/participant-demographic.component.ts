...
@Component({
  selector: 'app-participant-demographic',
  templateUrl: './participant-demographic.component.html',
  styleUrls: ['./participant-demographic.component.scss']
})
export class ParticipantDemographicComponent implements OnInit {

  standard_name = "participant_demographic_surveys";
  ...
  getUploadedArtifacts() {
    this.artifactService.get({ participant_demographic_surveys: true, is_acm: true, experiment: this.id_experiment }).subscribe((data: any) => {
  ...
  save(file_url, file_content, artifact_name) {
    ...
    const artifact = {
      name: artifact_name,
      file_content: 'Participant demographic surveys',
      ...
      participant_demographic_surveys: true,
      task: null
    }
  ...
  update(file_url, storage_ref, artifact_name) {
