...
@Component({
  ...
  templateUrl: './authors-file-replicated.component.html',
  styleUrls: ['./authors-file-replicated.component.scss']
})
export class AuthorsFileReplicatedComponent implements OnInit {
  ...
  save(file_url, file_content, isGenerated) {
    ...
    const artifact = {
      name: 'Archivo autores replicado',
      file_content: 'Archivo autores replicado',
