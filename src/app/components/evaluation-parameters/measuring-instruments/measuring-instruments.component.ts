...
@Component({
  selector: 'app-measuring-instruments',
  templateUrl: './measuring-instruments.component.html',
  styleUrls: ['./measuring-instruments.component.scss']
})
export class MeasuringInstrumentsComponent implements OnInit {

  standard_name = "measuring_instruments";
  ...
  getUploadedArtifacts() {
    this.artifactService.get({ measuring_instruments: true, is_acm: true, experiment: this.id_experiment }).subscribe((data: any) => {
  ...
  save(file_url, file_content, artifact_name) {
    ...
    const artifact = {
      name: artifact_name,
      file_content: 'Measuring instruments',
