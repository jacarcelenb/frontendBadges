...
@Component({
  selector: 'app-execution-time-complete',
  templateUrl: './execution-time-complete.component.html',
  styleUrls: ['./execution-time-complete.component.scss']
})
export class ExecutionTimeCompleteComponent implements OnInit {
  standard_name = "tiempos_ejecucion_completa";
