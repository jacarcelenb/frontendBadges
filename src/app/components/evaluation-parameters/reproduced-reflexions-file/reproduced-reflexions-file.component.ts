...
@Component({
  selector: 'app-reproduced-reflexions-file',
  templateUrl: './reproduced-reflexions-file.component.html',
  styleUrls: ['./reproduced-reflexions-file.component.scss']
})
export class ReproducedReflexionsFileComponent implements OnInit {
    ...
    if (this.Form.value.dificultades.length == 0 || this.Form.value.mejoras.length == 0 ||
      ...
      autoTable(doc, {
        body: [
          [
            {
              content: 'Reproduced Reflexions File',
              styles: {
                halign: 'left',
                fontSize: 9,
                fontStyle: 'bold',
      ...
      autoTable(doc, {
        body: [
          [
            ...
            {
              content: 'The Reflexions file describes the difficulties, improvements, limitations and lessons learned during the reproduction.',
            }
      ...
      //this.createEvaluationStandard()
      return doc.save("Reproduced_Reflexions_File.pdf")
    }
  }
