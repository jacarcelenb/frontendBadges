...
@Component({
  ...
  styleUrls: ['./justification-file.component.scss']
})
export class JustificationFileComponent implements OnInit {
    ...
    if (this.textfile.nativeElement.value.trim().length == 0) {
      ...
      autoTable(doc, {
        body: [
          [
            {
              content: 'Reproduced Justifcation File',
              styles: {
                halign: 'left',
                fontSize: 9,
                fontStyle: 'bold',
      ...
      autoTable(doc, {
        body: [
          [
            ...
            {
              content: 'The Justification File is a document that presents the justification and appropriate documents to obtain the reproduced badge.',
            }
