...
@Component({
  selector: 'app-type-package',
  templateUrl: './type-package.component.html',
  styleUrls: ['./type-package.component.scss']
})
export class TypePackageComponent implements OnInit {
  @Output() closeView: EventEmitter<any> = new EventEmitter<any>();
  isChecked = false;
  standard_name = "registro_tipo_paquete";
