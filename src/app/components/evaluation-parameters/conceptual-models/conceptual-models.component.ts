...
@Component({
  selector: 'app-conceptual-models',
  templateUrl: './conceptual-models.component.html',
  styleUrls: ['./conceptual-models.component.scss']
})
export class ConceptualModelsComponent implements OnInit {
  standard_name = "conceptual_models";
  ...
  getUploadedArtifacts() {
    this.artifactService.get({ conceptual_models: true, is_acm: true, experiment: this.id_experiment }).subscribe((data: any) => {
  ...
  save(file_url, file_content, artifact_name) {
    ...
    const artifact = {
      name: artifact_name,
      file_content: 'Conceptual models',
