...
@Component({
  selector: 'app-instruction-guide-execute',
  templateUrl: './instruction-guide-execute.component.html',
  styleUrls: ['./instruction-guide-execute.component.scss']
})
export class InstructionGuideExecuteComponent implements OnInit {
  standard_name = "guia_instrucciones_ejecutar";
  isLoading = false;
...
save(file_url, file_content,isGenerated) {
  ...
  const artifact = {
    name: 'Guía de instrucciones de ejecución',
    file_content: 'Guía de instrucciones de ejecución',
...
update(file_url, storage_ref) {
  ...
  generateInstructionsGuide() {
    this.isLoading = true;
    const instructions_guide = this.instructionsGuideForm.get('instructions_guide').value;
  }
  ...
  generatePDFfile() {
    ...
    autoTable(doc, {
      body: [
        [
          {
            content: 'This Instruction Guide Execute file describes how to use the artifacts that were used during the experiment.',
          }
    ...
    autoTable(doc, {
      body: [
        [
          {
            content: 'Instruction Guide Execute',
          }
          ,
        ],
      ],
