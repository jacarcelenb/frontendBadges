...
@Component({
  selector: 'app-design-description',
  templateUrl: './design-description.component.html',
  styleUrls: ['./design-description.component.scss']
})
export class DesignDescriptionComponent implements OnInit {
  standard_name = "design_description";
  ...
  constructor(private actRoute: ActivatedRoute,
    ...
    getUploadedArtifacts() {
      this._artifactService.get({ name: "Design description", is_acm: true, experiment: this.id_experiment  }).subscribe((data: any) => {
    ...
    generatePDFfile(artifact){
      ...
      autoTable(doc, {
        body: [
          [
            {
              content: 'Design description File',
              styles: {
                halign: 'left',
                fontSize: 9,
                fontStyle: 'bold',
      ...
      autoTable(doc, {
        body: [
          [
            ...
            {
              content: 'Design description file explains the experimental design.',
            }
      ...
      let fileData = new File([blobPDF], "Design description.pdf", { type: blobPDF.type })
  ...
  save(file_url, file_content,isGenerated) {
    ...
    const artifact = {
      ...
      file_content: 'Design description',
